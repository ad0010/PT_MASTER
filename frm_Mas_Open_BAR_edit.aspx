<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home.Master" CodeBehind="frm_Mas_Open_BAR_edit.aspx.vb" Inherits="PT_MASTER.frm_Mas_Open_BAR_edit" %>
    ...
    <table class="auto-style1">
        <tr>
            <td class="auto-style2">
                ...
                <tr><td>รายละเอียด :</td><td><asp:TextBox ID="TextBox2" runat="server" CausesValidation="True" Width="236px"></asp:TextBox></td></tr>
                    </table>
